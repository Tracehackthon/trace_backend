...
const PRODUCT_USAGE = [
    ...
    '  trace source update --file ABS --confirm true [--project-dir ABS]  # explicitly accept a reviewed external/team source-profile change',
...
const ADVANCED_USAGE = [
    ...
    '  trace source update --file ABS --confirm true [--project-dir ABS]  # reviewed external/team selected-source profile update',
