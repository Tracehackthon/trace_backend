...
当前完成本机 Web 链路及 Codex MCP 的隔离 receive/return 往返。Agent 后端见[独立说明](../agent/README.md)；页面自动模型回复、联网来源展示、其他外部 Agent、云账号 / 同步、移动端及桌面打包不在该 Web 已验证范围。不要把旧原型的 mock 讨论当作已连接模型。
