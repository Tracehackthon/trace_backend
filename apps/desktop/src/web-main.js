...
const allowed=['home','matters','chain','compare','worksite','works','search','all','host','discussion'];
...
async function renderRoute(){
  ...
  try{
    ...
    if(view==='home'){
      ...
      document.title='Trace · 宿主会话';
      screen=mountHostSession({root,onBack:back});
