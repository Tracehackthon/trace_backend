...
export async function fixture(t, { adapter, timeoutMs = 1000 } = {}) {
  ...
  const service = createAgentService({ store: agentStore, readWorkspace: webStore.read, adapter, timeoutMs, pollMs: 10 });
