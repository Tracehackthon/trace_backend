...
const entries = [
  '.changeset', '.gitignore', 'Connect-Trace-to-Codex.cmd', 'apps', 'governance', 'AUDIT_20260909.md', 'docs', 'GIT_REMOTE_SETUP.md', 'MIGRATION_STATUS.md', 'README.md',
  'marketplace.json', 'mise.toml', 'native', 'package.json', 'packages', 'patches', 'plugins', 'pnpm-lock.yaml',
