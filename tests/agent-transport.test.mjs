...
import { CodexConnection, BOUNDED_CONFIG, boundedCodexEnv } from '../apps/agent/codex.mjs';
...
test('Codex child environment excludes other profile credentials and host-scoped session metadata', () => {
  const result = boundedCodexEnv({ PATH: 'safe', MODEL_TOKEN: 'secret', ZHIHU_ACCESS_TOKEN: 'secret', CODEX_THREAD_ID: 'parent' }, ['MODEL_TOKEN']);
